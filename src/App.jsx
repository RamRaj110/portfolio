            ...
            <div className="md:w-1/2 space-y-6">
              ...
              <div className="flex space-x-4">
                <motion.button
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="bg-blue-600 text-white px-6 py-3 rounded-full hover:bg-blue-800 transition-colors flex items-center space-x-2"
                  onClick={() =>
                    document
                ...
                <motion.button
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="bg-gray-700 text-white px-6 py-3 rounded-full hover:bg-gray-600 transition-colors flex items-center space-x-2"
              ...
              >
                <div className="flex ">
                  <a
                    ...
                    target="_blank"
                  >
                    <Linkedin className="w-6 h-6 mx-4 cursor-pointer hover:text-blue-600 transition-colors" />
                  </a>
                  <a href="https://github.com/RamRaj110" target="_blank">
